...
interface HomeDocumentData {
    ...
    /**
     * tittle web field in *Home*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: home.tittle_web
     * - **Tab**: Main
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    tittle_web: prismicT.RichTextField;
    /**
...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { AboutDocumentData, AboutDocument, HomeDocumentData, HomeDocumentDataSlicesSlice, HomeDocument, PostDocumentData, PostDocument, AllDocumentTypes, HomeSliceDefaultPrimary, HomeSliceDefault, HomeSliceVariation, HomeSlice };
    }
}
